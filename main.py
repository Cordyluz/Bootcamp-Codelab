...
tabela_nutricional = {
    ...
    "carne de porco":242,
    "peixe frito":232,
    "peixe cozido tilápia":108,
    "peixo cozido salmão":273,
    "alface":15,
    "tomate":18,
    "mamão":43,
    "ovo":155,
...
if __name__ == "__main__":
    ...
    def contagem_calorias(chat,message):
        ...
        # Resposta da I.A.
        try: 
            calorias_calculadas = model.generate(prompt_calculo_calorias, max_tokens=100, stopping_tokens=["\n"])["answer"]
